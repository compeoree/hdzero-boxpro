...
void keyboard_init() {
    if (!g_keyboard.input || !g_keyboard.text) {
        ...
        // Placement
        lv_obj_align(g_keyboard.text, LV_ALIGN_BOTTOM_MID, 0, -250);
        lv_obj_set_size(g_keyboard.input, 980, 250);
        lv_obj_set_size(g_keyboard.text, 980, 40);
        ...
        lv_obj_set_style_bg_color(g_keyboard.input, lv_color_hex(0x404040), LV_PART_ITEMS);
        ...
        lv_obj_set_pos(g_keyboard.dial_scroll_img, 346, 64);
        ...
        lv_obj_set_style_text_font(g_keyboard.dial_scroll_text, &lv_font_montserrat_18, 0);
        lv_obj_set_style_text_align(g_keyboard.dial_scroll_text, LV_TEXT_ALIGN_LEFT, 0);
        lv_obj_set_pos(g_keyboard.dial_scroll_text, 450, 96);
        ...
        lv_obj_set_pos(g_keyboard.dial_click_img, 612, 64);
        ...
        lv_obj_set_style_text_font(g_keyboard.dial_click_text, &lv_font_montserrat_18, 0);
        lv_obj_set_style_text_align(g_keyboard.dial_click_text, LV_TEXT_ALIGN_LEFT, 0);
        lv_obj_set_pos(g_keyboard.dial_click_text, 710, 96);
        ...
        lv_obj_set_pos(g_keyboard.right_button_img, 822, 64);
        ...
        lv_obj_set_style_text_font(g_keyboard.right_button_text, &lv_font_montserrat_18, 0);
        lv_obj_set_style_text_align(g_keyboard.right_button_text, LV_TEXT_ALIGN_LEFT, 0);
        lv_obj_set_pos(g_keyboard.right_button_text, 906, 85);
