...
static lv_coord_t col_dsc1[] = {320, 12, 420, LV_GRID_TEMPLATE_LAST};
static lv_coord_t row_dsc1[] = {40, 40, 50, LV_GRID_TEMPLATE_LAST};

static lv_coord_t col_dsc2[] = {80, 52, 52, 120, 60, 52, 52, 120, LV_GRID_TEMPLATE_LAST};
static lv_coord_t row_dsc2[] = {40, 40, 40, 40, 40, 40, 40, 40, 40, 40, LV_GRID_TEMPLATE_LAST};
...
static void create_channel_switch(lv_obj_t *parent, int col, int row, channel_t *channel) {
    ...
    lv_obj_set_style_text_font(channel->label, &lv_font_montserrat_26, 0);
    ...
    lv_obj_set_style_pad_top(channel->label, 8, 0);
...
static lv_obj_t *page_scannow_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    lv_obj_set_size(progressbar, 320, 32);
    lv_obj_center(progressbar);
    lv_bar_set_value(progressbar, 0, LV_ANIM_OFF);
    lv_obj_set_style_bg_color(progressbar, lv_color_hex(TEXT_COLOR_DEFAULT), LV_PART_MAIN);
