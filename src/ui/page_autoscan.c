...
static lv_coord_t col_dsc[] = {106, 100, 120, 146, 120, 106, LV_GRID_TEMPLATE_LAST};
...
static lv_obj_t *page_autoscan_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    create_btn_group_item2(&btn_group1, cont, 5, "Default", "Last", "HDZero", "Analog", "AV In", "HDMI In", " ", 1); // 2 rows
    create_label_item(cont, "< Back", 1, 3, 1);

    lv_obj_t *label2 = lv_label_create(cont);
    lv_label_set_text(label2, "*if Auto Scan is 'Last', box will default to show last tuned channel");
