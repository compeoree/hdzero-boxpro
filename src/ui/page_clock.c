...
static lv_coord_t row_dsc[] = {40, 40, 40, 40, 40, 10, 6, 40, 40, 40, LV_GRID_TEMPLATE_LAST};
...
static void page_clock_create_dropdown(lv_obj_t *parent,
    ...
    page_clock_items[item].data.obj = create_dropdown_item(parent, page_clock_options[item].list, col, row, 106, 26, 1, 4, LV_GRID_ALIGN_START, &lv_font_montserrat_16);
