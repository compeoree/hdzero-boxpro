 ...
 */
static lv_coord_t col_dsc[] = {106, 130, 106, 106, 106, 80, LV_GRID_TEMPLATE_LAST};
static lv_coord_t row_dsc[] = {40, 40, 40, 40, 40, 40, 40, 40, 40, LV_GRID_TEMPLATE_LAST};
...
const char *rollerOptions[] = {"Switch channel", "Change fan speed", "LCD Brightness"};
...
static lv_obj_t *page_input_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    lv_obj_set_size(page, contentWidth + 62, contentHeight + 200);
    lv_obj_add_style(page, &style_subpage, LV_PART_MAIN);
    lv_obj_set_style_pad_top(page, 62, 0);

    lv_obj_t *section = lv_menu_section_create(page);
    lv_obj_add_style(section, &style_submenu, LV_PART_MAIN);
    lv_obj_set_size(section, contentWidth + 62, contentHeight + 200);
    ...
    pageItems[ROLLER] = create_dropdown_item(content, rollerOptionsStr, 2, ROLLER, 210, row_dsc[ROLLER], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
    lv_dropdown_set_selected(pageItems[ROLLER], rollerDefaultOption);

    create_label_item(content, "Left short:", 1, LEFT_SHORT, 1);
    pageItems[LEFT_SHORT] = create_dropdown_item(content, btnOptionsStr, 2, LEFT_SHORT, 210, row_dsc[LEFT_SHORT], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
    ...
    pageItems[LEFT_LONG] = create_dropdown_item(content, btnOptionsStr, 2, LEFT_LONG, 210, row_dsc[LEFT_LONG], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
    ...
    pageItems[RIGHT_SHORT] = create_dropdown_item(content, btnOptionsStr, 2, RIGHT_SHORT, 210, row_dsc[RIGHT_SHORT], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
    ...
    pageItems[RIGHT_LONG] = create_dropdown_item(content, btnOptionsStr, 2, RIGHT_LONG, 210, row_dsc[RIGHT_LONG], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
    ...
    pageItems[RIGHT_DOUBLE] = create_dropdown_item(content, btnOptionsStr, 2, RIGHT_DOUBLE, 210, row_dsc[RIGHT_DOUBLE], 2, 10, LV_GRID_ALIGN_START, &lv_font_montserrat_18);
