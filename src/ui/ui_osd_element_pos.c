...
static int ui_handle_click() {
    ...
    case ROW_RESET_ELEMENTS:
        ...
        if (reset_all_elements_confirm) {
            ...
            update_ui();
            osd_update_element_positions();
            lv_label_set_text(label_reset_all_osd_elements, "#008000 Elements reset.#");
...
void ui_osd_element_pos_init(void) {
    ...
    // create all elements
    create_btn_group_item_compact(&btn_group_osd_mode, ui_root_container, 2, "Mode", "4x3", "16x9", "", "", ROW_OSD_MODE, 40, 80, &lv_font_montserrat_14);

    create_label_item_compact(ui_root_container, "Element: ", 1, ROW_OSD_ELEMENT, 1, 40, LV_TEXT_ALIGN_LEFT, LV_GRID_ALIGN_START, &lv_font_montserrat_14);
    ...
    create_btn_group_item_compact(&btn_group_osd_show_element, ui_root_container, 2, "Show", "Yes", "No", "", "", ROW_OSD_SHOW_ELEMENT, 40, 80, &lv_font_montserrat_14);
    create_slider_item_compact(&slider_group_osd_element_pos_x, ui_root_container, "Pos-X", OSD_ELEMENT_MAX_X_POS, 0, ROW_OSD_ELEMENT_POS_X, &lv_font_montserrat_14);
    create_slider_item_compact(&slider_group_osd_element_pos_y, ui_root_container, "Pos-Y", OSD_ELEMENT_MAX_Y_POS, 0, ROW_OSD_ELEMENT_POS_Y, &lv_font_montserrat_14);
    label_save_osd_elements = create_label_item_compact(ui_root_container, "Save changes", 0, ROW_SAVE, 5, 30, LV_TEXT_ALIGN_CENTER, LV_GRID_ALIGN_CENTER, &lv_font_montserrat_14);
    label_cancel_osd_elements = create_label_item_compact(ui_root_container, "Cancel", 0, ROW_CANCEL, 5, 30, LV_TEXT_ALIGN_CENTER, LV_GRID_ALIGN_CENTER, &lv_font_montserrat_14);
    label_reset_all_osd_elements = create_label_item_compact(ui_root_container, "Reset all elements (both modes)", 0, ROW_RESET_ELEMENTS, 5, 30, LV_TEXT_ALIGN_CENTER, LV_GRID_ALIGN_CENTER, &lv_font_montserrat_14);
