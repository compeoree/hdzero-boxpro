 ...
 *  Globals
 */
static lv_coord_t col_dsc[] = {106, 106, 106, 120, 106, 106, LV_GRID_TEMPLATE_LAST};
static lv_coord_t row_dsc[] = {40, 40, 40, 40, 40, 40, 40, 26, LV_GRID_TEMPLATE_LAST};
...
static void page_wifi_create_page_1(lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_font(page_wifi.page_1.note, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_pad_top(page_wifi.page_1.note, 8, 0);
...
static void page_wifi_create_page_3(lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_font(page_wifi.page_3.note, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_pad_top(page_wifi.page_3.note, 8, 0);
