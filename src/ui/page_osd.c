...
static lv_coord_t col_dsc[] = {106, 120, 106, 106, 80, 106, LV_GRID_TEMPLATE_LAST};
...
static lv_obj_t *page_osd_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    lv_obj_set_style_text_font(label_user_hint, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_pad_top(label_user_hint, 8, 0);
