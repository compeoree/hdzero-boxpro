...
static lv_coord_t col_dsc[] = {106, 106, 106, 106, 92, 146, LV_GRID_TEMPLATE_LAST};
...
static lv_obj_t *page_imagesettings_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    create_slider_item(&slider_group, cont, "LCD", 12, g_setting.image.oled, 0);
    ...
    create_slider_item(&slider_group4, cont, "LCD Auto off", 3, g_setting.image.auto_off, 4);
